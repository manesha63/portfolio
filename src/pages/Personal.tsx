      ...
      <div className="cosmic-background min-h-screen">
        <div className="section-container pt-24 px-4 md:px-6">
          ...
          >
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-gradient text-center mb-8">Questions, Queries, Comments, Feedback — All Welcome!</h2>
              <div className="max-w-2xl mx-auto">
                <form onSubmit={handleSubmit} className="card hover-glow space-y-6">
                  <div>
                    <textarea
                      id="question"
                      value={question}
